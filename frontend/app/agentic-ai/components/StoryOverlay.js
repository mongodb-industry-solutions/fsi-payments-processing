 ...
 *
 * Cards advance immediately when events arrive - no queue delay.
...
export default function StoryOverlay({
  ...
  // Auto-advance to latest card when new steps are triggered
  useEffect(() => {
    if (triggeredSteps.length > 0 && autoAdvance) {
