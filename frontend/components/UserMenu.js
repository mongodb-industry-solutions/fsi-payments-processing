...
const LEAFY_BANK_HOME = "https://leafy-bank-bian-ui.industrysolutions.prod.corp.mongodb.com/";
...
const SECTIONS = [
    {
        ...
        users: [
            { id: "65a546ae4a8f64e8f88fb89e", name: "Frida", role: "Leafy Bank Customer", url: LEAFY_BANK_HOME },
        ],
    },
    {
        section: "backoffice",
        label: "Backoffice",
        users: [
            { id: "67a1000000000000000000001", name: "Marc", role: "Finance Operator", url: "https://leafy-bank-bian.industrysolutions.prod.corp.mongodb.com/gl-pipeline-monitor" },
            { id: "67a1000000000000000000002", name: "Ana", role: "Risk Analyst", url: "https://fsi-fraud-detection.industrysolutions.prod.corp.mongodb.com/?userEmail=ainhoa.mugica%40mongodb.com&sessionGoal=Development+%2F+Test" },
            { id: "67a1000000000000000000004", name: "Sophia", role: "Investment Portfolio Manager", url: "https://leafy-bank-ui.industrysolutions.prod.corp.mongodb.com/asset-portfolio" },
            { id: "67a1000000000000000000003", name: "Luke", role: "Payments Operations", url: null },
            { id: "67a1000000000000000000006", name: "Maria", role: "Document Analyst", url: "https://document-intelligence-ui.industrysolutions.prod.corp.mongodb.com/use-case" },
        ],
    },
];

const CURRENT_USER = SECTIONS.flatMap((s) => s.users).find((u) => u.id === CURRENT_USER_ID);
