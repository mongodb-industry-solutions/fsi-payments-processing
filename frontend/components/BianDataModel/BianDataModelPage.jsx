...
// Collections this demo actually reads/writes (per DB_MAP). Highlighted in the
// explorer so viewers can see which of the consolidated collections belong here.
const DEMO_DB = "fsi-payments-processing";
const DEMO_COLLECTIONS = new Set(DB_MAP[DEMO_DB] || []);
    ...
    <div>
      <div className={styles.domainHeader} style={{ "--accent": color }}>
        ...
        <div className={styles.dhRight}>
          {DEMO_COLLECTIONS.has(activeKey) && (
            ...
            return (
              <React.Fragment key={group}>
                ...
                {groupDomains.map((d) => {
                  ...
                  const isDemo = DEMO_COLLECTIONS.has(d.key);
                  return (
                    <button
                      key={d.key}
                      type="button"
